...
export interface Preference {
  emulator: {
    ...
    fullscreen: boolean
    platform: Record<PlatformName, { bios: { fileId: string; fileName: string }[]; core: CoreName }>
    shader: string
    videoSmooth: boolean
  }
  input: {
...
export const defaultPreference: ResolvedPreference = {
  emulator: {
    ...
    fullscreen: false,
    platform: {
      arcade: { bios: [], core: 'mame2003_plus' },
      atari2600: { bios: [], core: 'stella2014' },
      atari5200: { bios: [], core: 'a5200' },
      atari7800: { bios: [], core: 'prosystem' },
      atarilynx: { bios: [], core: 'mednafen_lynx' },
      famicom: { bios: [], core: 'fceumm' },
      fds: { bios: [], core: 'fceumm' },
      gamegear: { bios: [], core: 'genesis_plus_gx' },
      gb: { bios: [], core: 'mgba' },
      gba: { bios: [], core: 'mgba' },
      gbc: { bios: [], core: 'mgba' },
      genesis: { bios: [], core: 'genesis_plus_gx' },
      megadrive: { bios: [], core: 'genesis_plus_gx' },
      nes: { bios: [], core: 'fceumm' },
      ngp: { bios: [], core: 'mednafen_ngp' },
      ngpc: { bios: [], core: 'mednafen_ngp' },
      sega32x: { bios: [], core: 'picodrive' },
      sfc: { bios: [], core: 'snes9x' },
      'sg-1000': { bios: [], core: 'gearsystem' },
      sms: { bios: [], core: 'genesis_plus_gx' },
      snes: { bios: [], core: 'snes9x' },
      vb: { bios: [], core: 'mednafen_vb' },
      wonderswan: { bios: [], core: 'mednafen_wswan' },
      wonderswancolor: { bios: [], core: 'mednafen_wswan' },
    },
    shader: '',
    videoSmooth: false,
  },
