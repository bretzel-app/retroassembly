export const translation = {
  ...
  gameStats: '总共有<1>{{gameCount}}</1>个游戏，<3>{{platformCount}}</3>个平台',
  Genesis: 'Genesis',
  Genres: '类型',
  ...
  Platform: '平台',
  playedGamesStats: '已玩过<1>{{gameCount}}</1>个游戏',
  Players: '玩家数',
  ...
  // Platform page
  platformGamesStats: '{{platform}}平台有<1>{{gameCount}}</1>个游戏。',
}
