export const translation = {
  ...
  'for demonstration': 'pour la démonstration',
  ...
  gameStats:
    '<1>{{gameCount}}</1> {{gameCountPlural, plural, one {jeu} other {jeux}}} pour <3>{{platformCount}}</3> {{platformCountPlural, plural, one {plateforme} other {plateformes}}} au total',
  Genesis: 'Genesis',
  Genres: 'Genres',
  ...
  Platform: 'Plateforme',
  playedGamesStats: 'Joué à <1>{{gameCount}}</1> {{gameCountPlural, plural, one {jeu} other {jeux}}}',
  Players: 'Joueurs',
  ...
  // Platform page
  platformGamesStats: '{{gameCount}} {{gameCountPlural, plural, one {jeu} other {jeux}}} pour {{platform}}.',
}
