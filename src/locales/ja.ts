export const translation = {
  ...
  Error: 'エラー',
  'Expected BIOS file': '期待されるBIOSファイル: ',
  ...
  gameStats: '<3>{{platformCount}}</3>プラットフォームで合計<1>{{gameCount}}</1>ゲームがあります',
  Genesis: 'Genesis',
  Genres: 'ジャンル',
  ...
  Platform: 'プラットフォーム',
  playedGamesStats: '<1>{{gameCount}}</1>ゲームをプレイしました',
  Players: 'プレイヤー数',
  ...
  // Platform page
  platformGamesStats: '{{platform}}の<1>{{gameCount}}</1>ゲーム。',
}
