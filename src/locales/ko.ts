export const translation = {
  ...
  Error: '오류',
  'Expected BIOS file': '예상되는 BIOS 파일: ',
  ...
  gameStats: '총 <3>{{platformCount}}</3>개 플랫폼에서 <1>{{gameCount}}</1>개의 게임이 있습니다',
  Genesis: 'Genesis',
  Genres: '장르',
  ...
  Platform: '플랫폼',
  playedGamesStats: '<1>{{gameCount}}</1>개의 게임을 플레이했습니다',
  Players: '플레이어 수',
  ...
  // Platform page
  platformGamesStats: '{{platform}}의 <1>{{gameCount}}</1>개 게임.',
}
