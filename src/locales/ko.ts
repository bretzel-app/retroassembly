...
export const translation: ResourceLanguage = {
  ...
  About: '정보',
  Accept: '수락',
  'Access the application': '애플리케이션에 접속',
  ...
  Arcade: '아케이드',
  'Are you sure? This action cannot be undone.': '확실합니까? 이 작업은 실행 취소할 수 없습니다.',
  ...
  'Cannot delete yourself': '자신을 삭제할 수 없습니다',
  'Change Password': '비밀번호 변경',
  'Change Your Password': '내 비밀번호 변경',
  'Channel F': 'Channel F',
  Close: '닫기',
  'Cloud Sync': '클라우드 동기화',
  ...
  'Once the container is running, open http://localhost:8000 in your browser.':
    '컨테이너가 실행되면 브라우저에서 http://localhost:8000 을(를) 열어주세요.',
  'Oops!': '앗!',
  Options: '옵션',
  or: '또는',
  Password: '비밀번호',
  ...
  'Run with Docker CLI': 'Docker CLI로 실행',
  Save: '저장',
  'Save & Exit': '저장하고 종료',
  'Saved at': '저장된 시간',
  'Saved States': '저장된 상태',
  ...
  state: '상태',
  'Step 1: Create compose.yaml': '1단계: compose.yaml 생성',
  'Step 2: Start the container': '2단계: 컨테이너 시작',
  Super: '슈퍼',
  ...
  Version: '버전',
  Video: '비디오',
  'View on Docker Hub': 'Docker Hub에서 보기',
