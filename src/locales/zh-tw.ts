...
export const translation: ResourceLanguage = {
  ...
  Arcade: '街機',
  'Are you sure? This action cannot be undone.': '您確定嗎？此操作無法復原。',
  ...
  'Once the container is running, open http://localhost:8000 in your browser.':
    '容器啟動後，請在瀏覽器開啟 http://localhost:8000。',
  'Oops!': '糟糕！',
  Options: '選項',
  or: '或',
  Password: '密碼',
  ...
  'Run with Docker CLI': '使用 Docker CLI 執行',
  Save: '儲存',
  'Save & Exit': '儲存並退出',
  'Saved at': '儲存於',
  'Saved States': '已儲存的狀態',
  ...
  state: '狀態',
  'Step 1: Create compose.yaml': '步驟 1：建立 compose.yaml',
  'Step 2: Start the container': '步驟 2：啟動容器',
  Super: '超級',
  ...
  Version: '版本',
  Video: '影片',
  'View on Docker Hub': '前往 Docker Hub 查看',
