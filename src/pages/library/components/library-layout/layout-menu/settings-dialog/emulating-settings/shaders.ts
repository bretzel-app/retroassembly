...
export const shaders = [
  ...
  { id: 'anti-aliasing/fxaa', name: 'fxaa', thumbnail: '' },
  { id: 'crt/crt-aperture', name: 'crt-aperture', thumbnail: '' },
  { id: 'crt/crt-cgwg-fast', name: 'crt-cgwg-fast', thumbnail: '' },
  ...
  { id: 'crt/crt-hyllian', name: 'crt-hyllian', thumbnail: '' },
  { id: 'crt/crt-lottes', name: 'crt-lottes', thumbnail: '' },
  ...
  { id: 'crt/yee64', name: 'yee64', thumbnail: '' },
