...
export function StatusBar() {
  ...
  return (
    <div className='bg-(--accent-9) z-11 fixed bottom-0 left-72 right-0 hidden h-12 items-center justify-end gap-4 pr-8 text-sm font-medium text-white/80 lg:flex'>
      {connected ? (
        <>
