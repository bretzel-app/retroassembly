...
export const routes = {
  ...
  libraryGameList: '/library/lists/:listId',
  libraryGameLists: '/library/lists',
...
export default [
  ...
  route(routes.libraryGameList, 'routes/library-game-list.tsx'),
  route(routes.libraryGameLists, 'routes/library-game-lists.tsx'),
