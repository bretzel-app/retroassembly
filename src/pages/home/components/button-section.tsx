...
export function ButtonSection() {
  ...
  return (
    <section className='relative py-8 lg:py-20'>
      ...
      <div className='lg:w-2xl border-(--accent-9) bg-(--color-background) in-[.dark]:bg-(--gray-2) relative mx-5 rounded-xl border-2 p-5 shadow-[0_0_32px_rgba(0,0,0,0.2)] lg:mx-auto'>
